...
Define the long-term server auth architecture for NJ Code before first-class remote environments ship.
...
Every privileged surface of the NJ server must go through the same auth policy engine:
