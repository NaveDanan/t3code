      ...
      return {
          ...
          set((state) => {
            ...
            if (normalized) {
              ...
              if (normalized.options !== undefined) {
                ...
                (nextMap as Record<string, ModelSelection>)[normalized.provider] = normalized;
              } else {
                // No options in selection → preserve existing options, update provider+model
                (nextMap as Record<string, ModelSelection>)[normalized.provider] = {
        ...
        setProviderModelOptions: (threadRef, provider, nextProviderOptions, options) => {
          ...
          set((state) => {
            ...
            if (providerOpts) {
              (nextMap as Record<string, ModelSelection>)[normalizedProvider] = {
            ...
            if (options?.persistSticky === true) {
              ...
              if (providerOpts) {
                (nextStickyMap as Record<string, ModelSelection>)[normalizedProvider] = {
                  ...stickyBase,
                  provider: normalizedProvider,
                  options: providerOpts,
                } as ModelSelection;
