...
files:
  - url: NJ-Code-9.9.9-smoke.0-arm64.zip
    sha512: arm64zip
    size: 125621344
  - url: NJ-Code-9.9.9-smoke.0-arm64.dmg
    sha512: arm64dmg
    size: 131754935
path: NJ-Code-9.9.9-smoke.0-arm64.zip
sha512: arm64zip
...
`,
  ...
  writeFileSync(
    ...
    `version: 9.9.9-smoke.0
files:
  - url: NJ-Code-9.9.9-smoke.0-x64.zip
    sha512: x64zip
    size: 132000112
  - url: NJ-Code-9.9.9-smoke.0-x64.dmg
    sha512: x64dmg
    size: 138148807
path: NJ-Code-9.9.9-smoke.0-x64.zip
sha512: x64zip
...
try {
  ...
  assertContains(
    mergedManifest,
    "NJ-Code-9.9.9-smoke.0-arm64.zip",
    "Merged manifest is missing the arm64 asset.",
  );
  assertContains(
    mergedManifest,
    "NJ-Code-9.9.9-smoke.0-x64.zip",
